...
urlpatterns = [
    ...
    path("notification/create",views.create_notification,name="notification_create"),
    path("notification/notify",views.notify_event_update,name="notification_create"),
